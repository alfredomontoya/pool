...
export default function ClienteForm({ data, setData, errors, processing, onSubmit, reset = () => {} }: ClienteFormProps) {
  return (
    <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            <Select
              ...
              onValueChange={(valor) => setData("tipo_documento", valor)}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={data.estado}
              onValueChange={(valor) => setData("estado", valor)}
            >
              <SelectTrigger>
